...
export const translations: TranslationsByLanguage = {
  es: {
    ...
    invoices: {
      ...
      addInvoice: 'Crear Orden de Trabajo',
      editInvoice: 'Editar Orden de Trabajo',
      deleteInvoice: 'Eliminar Orden de Trabajo',
      invoiceDetails: 'Detalles de la Orden de Trabajo',
      invoiceNumber: 'Número de Orden',
      client: 'Cliente',
      project: 'Proyecto',
      issueDate: 'Fecha de Emisión',
      ...
      discount: 'Descuento',
      total: 'Total',
      amountPaid: 'Materiales Provistos',
      balance: 'Materiales Pendientes',
      notes: 'Notas',
      terms: 'Instrucciones de Trabajo',
      addItem: 'Agregar Material',
      itemDescription: 'Descripción',
      quantity: 'Cantidad',
      unitPrice: 'Precio Unitario',
      amount: 'Importe',
  ...
  en: {
    ...
    invoices: {
      title: 'Work Orders',
      addInvoice: 'Create Work Order',
      editInvoice: 'Edit Work Order',
      deleteInvoice: 'Delete Work Order',
      invoiceDetails: 'Work Order Details',
      ...
      discount: 'Discount',
      total: 'Total',
      amountPaid: 'Materials Provided',
      balance: 'Materials Needed',
      notes: 'Notes',
